...
public class HexagonScriptRefactor : MonoBehaviour
{
    ...
    void Start()
    {
        triangleData = EnchantmentTableManagerRefactor.instance.data.triangleData[transform.GetSiblingIndex()-1].position;
